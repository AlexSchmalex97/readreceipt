  ...
  return (
      ...
      >
        ...
        <div className="hidden md:block lg:hidden">
          ...
          {/* Tablet Three Column Layout: Recent Reviews - Activity Feed - TBR List */}
                      ...
                      item.kind === "progress" ? (
                        <div key={`p-${item.id}`} className="border border-border rounded-lg p-2">
                          ...
                          <div className="flex gap-2">
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="font-medium text-sm mb-0.5">Reading Progress</div>
                              <div className="text-xs text-muted-foreground line-clamp-2">
                                Page {item.to_page} {item.from_page ? `(from ${item.from_page})` : ''} of {item.book_title ?? "Untitled"}
                              </div>
                            </div>
                          </div>
                        </div>
            ...
            <Card style={{ backgroundColor: accentCardColor }}>
              ...
              <CardContent className="p-3 pt-0">
                {tbrBooks.length === 0 ? (
                  <div className="text-center py-8">
                    <BookOpen className="w-12 h-12 text-muted-foreground mx-auto mb-4" />
                    <p className="text-muted-foreground text-sm">Your TBR list is empty</p>
                  </div>
                ) : (
                  <div className="space-y-2.5 max-h-72 overflow-y-auto">
                    {tbrBooks.map((book) => (
