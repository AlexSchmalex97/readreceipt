    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <div className="lg:hidden">
          ...
          {/* Favorite/Currently Reading + Reading Goal Row */}
          <div className="flex gap-3 mb-3">
            {/* Left side - Favorite/Currently Reading stacked */}
            <div className="flex-1 space-y-2">
              {favoriteBook && (
                <div className="border rounded-lg p-1.5" style={{ backgroundColor: accentCardColor }}>
                  <p className="text-[10px] mb-1 font-medium" style={{ color: headerTextColor }}>Favorite Book</p>
                  <div className="flex gap-1.5">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-[11px] font-medium line-clamp-1 leading-tight" style={{ color: accentTextColor }}>{favoriteBook.title}</p>
                      <p className="text-[9px] truncate mt-0.5" style={{ color: accentTextColor, opacity: 0.7 }}>{favoriteBook.author}</p>
                    </div>
                  </div>
                </div>
              )}
              {currentBook && (
                <div className="border rounded-lg p-1.5" style={{ backgroundColor: accentCardColor }}>
                  <p className="text-[10px] mb-1 font-medium" style={{ color: headerTextColor }}>Currently Reading</p>
                  <div className="flex gap-1.5">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-[11px] font-medium line-clamp-1 leading-tight" style={{ color: accentTextColor }}>{currentBook.title}</p>
                      <p className="text-[9px] truncate mt-0.5" style={{ color: accentTextColor, opacity: 0.7 }}>{currentBook.author}</p>
                      <p className="text-[9px] mt-0.5" style={{ color: accentTextColor, opacity: 0.7 }}>
          ...
          {/* Stats - Below the goal/favorite section */}
        ...
        <div className="hidden lg:block">
          ...
          {/* Favorite/Currently Reading + Reading Goal Row - Desktop */}
              ...
              {favoriteBook && (
                <div>
                  ...
                  <div className="flex items-center gap-2 p-2 border rounded-lg bg-card" style={{ backgroundColor: accentCardColor }}>
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="font-medium text-xs line-clamp-1" style={{ color: accentTextColor }}>
                        {favoriteBook.title}
                      </div>
              ...
              {currentBook && (
                <div>
                  ...
                  <div className="flex items-center gap-2 p-2 border rounded-lg bg-card" style={{ backgroundColor: accentCardColor }}>
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="font-medium text-xs line-clamp-1" style={{ color: accentTextColor }}>{currentBook.title}</div>
