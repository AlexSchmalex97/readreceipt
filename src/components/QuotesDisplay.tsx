    ...
    <TooltipProvider>
      <Tooltip>
        <TooltipTrigger asChild>
          <div 
            className="flex items-center gap-2 sm:gap-3 px-3 sm:px-6 py-2 cursor-pointer hover:bg-accent/10 rounded-lg transition-colors max-w-full sm:max-w-md"
            onClick={handleQuoteChange}
          >
            <Quote className="w-5 h-5 text-primary flex-shrink-0" />
            
            <div className="flex-1 min-w-0">
              <div className="text-xs sm:text-sm text-foreground font-medium italic leading-tight line-clamp-2">
                "{currentQuote.text}"
              </div>
